...
SELECT tblPistes.Pista, tblParaules.Paraula
FROM tblIdiomes INNER JOIN (tblPistes INNER JOIN tblParaules ON tblPistes.IdPista = tblParaules.IdPista) ON (tblIdiomes.idIdioma = tblParaules.IdIdioma) AND (tblIdiomes.idIdioma = tblPistes.IdIdioma)
